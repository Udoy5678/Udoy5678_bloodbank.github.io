...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top: -20px;">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item" style="background-image: url('img/bloodtest.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>Second Slide</h3>
        ...
        <div class="carousel-item" style="background-image: url('img/laboratory.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>Third Slide</h3>
        ...
        {{--fourth slider--}}
        <div class="carousel-item" style="background-image: url('img/bag.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>Third Slide</h3>
